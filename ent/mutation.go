...
const (
	...
	TypeCounter         = "Counter"
	TypeIsps            = "Isps"
	TypeSiteSuggestions = "SiteSuggestions"
	TypeSites           = "Sites"
...
// SiteSuggestionsMutation represents an operation that mutates the SiteSuggestions nodes in the graph.
type SiteSuggestionsMutation struct {
	config
	op             Op
	typ            string
	id             *int
...
var _ ent.Mutation = (*SiteSuggestionsMutation)(nil)

// sitesuggestionsOption allows management of the mutation configuration using functional options.
type sitesuggestionsOption func(*SiteSuggestionsMutation)

// newSiteSuggestionsMutation creates new mutation for the SiteSuggestions entity.
func newSiteSuggestionsMutation(c config, op Op, opts ...sitesuggestionsOption) *SiteSuggestionsMutation {
	m := &SiteSuggestionsMutation{
		config:        c,
		op:            op,
		typ:           TypeSiteSuggestions,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withSiteSuggestionsID sets the ID field of the mutation.
func withSiteSuggestionsID(id int) sitesuggestionsOption {
	return func(m *SiteSuggestionsMutation) {
		var (
			err   error
			once  sync.Once
			value *SiteSuggestions
		)
		m.oldValue = func(ctx context.Context) (*SiteSuggestions, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().SiteSuggestions.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withSiteSuggestions sets the old SiteSuggestions of the mutation.
func withSiteSuggestions(node *SiteSuggestions) sitesuggestionsOption {
	return func(m *SiteSuggestionsMutation) {
		m.oldValue = func(context.Context) (*SiteSuggestions, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m SiteSuggestionsMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m SiteSuggestionsMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *SiteSuggestionsMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *SiteSuggestionsMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().SiteSuggestions.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetCreatedAt sets the "created_at" field.
func (m *SiteSuggestionsMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *SiteSuggestionsMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the SiteSuggestions entity.
// If the SiteSuggestions object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SiteSuggestionsMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreatedAt resets all changes to the "created_at" field.
func (m *SiteSuggestionsMutation) ResetCreatedAt() {
	m.created_at = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *SiteSuggestionsMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *SiteSuggestionsMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the SiteSuggestions entity.
// If the SiteSuggestions object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SiteSuggestionsMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUpdatedAt resets all changes to the "updated_at" field.
func (m *SiteSuggestionsMutation) ResetUpdatedAt() {
	m.updated_at = nil
}

// SetDomain sets the "domain" field.
func (m *SiteSuggestionsMutation) SetDomain(s string) {
	m.domain = &s
}

// Domain returns the value of the "domain" field in the mutation.
func (m *SiteSuggestionsMutation) Domain() (r string, exists bool) {
	v := m.domain
	if v == nil {
		return
	}
...
// OldDomain returns the old "domain" field's value of the SiteSuggestions entity.
// If the SiteSuggestions object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SiteSuggestionsMutation) OldDomain(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SiteSuggestionsMutation) ResetDomain() {
	m.domain = nil
}

// SetPingURL sets the "ping_url" field.
func (m *SiteSuggestionsMutation) SetPingURL(s string) {
	m.ping_url = &s
}

// PingURL returns the value of the "ping_url" field in the mutation.
func (m *SiteSuggestionsMutation) PingURL() (r string, exists bool) {
	v := m.ping_url
	if v == nil {
		return
	}
...
// OldPingURL returns the old "ping_url" field's value of the SiteSuggestions entity.
// If the SiteSuggestions object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SiteSuggestionsMutation) OldPingURL(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SiteSuggestionsMutation) ResetPingURL() {
	m.ping_url = nil
}

// SetCategories sets the "categories" field.
func (m *SiteSuggestionsMutation) SetCategories(s string) {
	m.categories = &s
}

// Categories returns the value of the "categories" field in the mutation.
func (m *SiteSuggestionsMutation) Categories() (r string, exists bool) {
	v := m.categories
	if v == nil {
		return
	}
...
// OldCategories returns the old "categories" field's value of the SiteSuggestions entity.
// If the SiteSuggestions object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SiteSuggestionsMutation) OldCategories(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SiteSuggestionsMutation) ClearCategories() {
	m.categories = nil
	m.clearedFields[sitesuggestions.FieldCategories] = struct{}{}
}

// CategoriesCleared returns if the "categories" field was cleared in this mutation.
func (m *SiteSuggestionsMutation) CategoriesCleared() bool {
	_, ok := m.clearedFields[sitesuggestions.FieldCategories]
	return ok
}

// ResetCategories resets all changes to the "categories" field.
func (m *SiteSuggestionsMutation) ResetCategories() {
	m.categories = nil
	delete(m.clearedFields, sitesuggestions.FieldCategories)
}

// SetReason sets the "reason" field.
func (m *SiteSuggestionsMutation) SetReason(s string) {
	m.reason = &s
}

// Reason returns the value of the "reason" field in the mutation.
func (m *SiteSuggestionsMutation) Reason() (r string, exists bool) {
	v := m.reason
	if v == nil {
		return
	}
...
// OldReason returns the old "reason" field's value of the SiteSuggestions entity.
// If the SiteSuggestions object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SiteSuggestionsMutation) OldReason(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SiteSuggestionsMutation) ResetReason() {
	m.reason = nil
}

// SetStatus sets the "status" field.
func (m *SiteSuggestionsMutation) SetStatus(s sitesuggestions.Status) {
	m.status = &s
}

// Status returns the value of the "status" field in the mutation.
func (m *SiteSuggestionsMutation) Status() (r sitesuggestions.Status, exists bool) {
	v := m.status
	if v == nil {
		return
	}
...
// OldStatus returns the old "status" field's value of the SiteSuggestions entity.
// If the SiteSuggestions object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SiteSuggestionsMutation) OldStatus(ctx context.Context) (v sitesuggestions.Status, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SiteSuggestionsMutation) ResetStatus() {
	m.status = nil
}

// SetResolveReason sets the "resolve_reason" field.
func (m *SiteSuggestionsMutation) SetResolveReason(s string) {
	m.resolve_reason = &s
}

// ResolveReason returns the value of the "resolve_reason" field in the mutation.
func (m *SiteSuggestionsMutation) ResolveReason() (r string, exists bool) {
	v := m.resolve_reason
	if v == nil {
		return
	}
...
// OldResolveReason returns the old "resolve_reason" field's value of the SiteSuggestions entity.
// If the SiteSuggestions object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SiteSuggestionsMutation) OldResolveReason(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldResolveReason is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldResolveReason requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldResolveReason: %w", err)
	}
	return oldValue.ResolveReason, nil
}

// ClearResolveReason clears the value of the "resolve_reason" field.
func (m *SiteSuggestionsMutation) ClearResolveReason() {
	m.resolve_reason = nil
	m.clearedFields[sitesuggestions.FieldResolveReason] = struct{}{}
}

// ResolveReasonCleared returns if the "resolve_reason" field was cleared in this mutation.
func (m *SiteSuggestionsMutation) ResolveReasonCleared() bool {
	_, ok := m.clearedFields[sitesuggestions.FieldResolveReason]
	return ok
}

// ResetResolveReason resets all changes to the "resolve_reason" field.
func (m *SiteSuggestionsMutation) ResetResolveReason() {
	m.resolve_reason = nil
...
func (m *SiteSuggestionsMutation) ResolvedAt() (r time.Time, exists bool) {
	v := m.resolved_at
	if v == nil {
		return
	}
...
// OldResolvedAt returns the old "resolved_at" field's value of the SiteSuggestions entity.
// If the SiteSuggestions object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SiteSuggestionsMutation) OldResolvedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SiteSuggestionsMutation) ClearResolvedAt() {
	m.resolved_at = nil
	m.clearedFields[sitesuggestions.FieldResolvedAt] = struct{}{}
}

// ResolvedAtCleared returns if the "resolved_at" field was cleared in this mutation.
func (m *SiteSuggestionsMutation) ResolvedAtCleared() bool {
	_, ok := m.clearedFields[sitesuggestions.FieldResolvedAt]
	return ok
}

// ResetResolvedAt resets all changes to the "resolved_at" field.
func (m *SiteSuggestionsMutation) ResetResolvedAt() {
	m.resolved_at = nil
...
// WhereP appends storage-level predicates to the SiteSuggestionsMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *SiteSuggestionsMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.SiteSuggestions, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *SiteSuggestionsMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *SiteSuggestionsMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (SiteSuggestions).
func (m *SiteSuggestionsMutation) Type() string {
	return m.typ
}
...
func (m *SiteSuggestionsMutation) Fields() []string {
	...
	if m.updated_at != nil {
		fields = append(fields, sitesuggestions.FieldUpdatedAt)
	}
	if m.domain != nil {
		fields = append(fields, sitesuggestions.FieldDomain)
	}
	if m.ping_url != nil {
		fields = append(fields, sitesuggestions.FieldPingURL)
	}
	if m.categories != nil {
		fields = append(fields, sitesuggestions.FieldCategories)
	}
	if m.reason != nil {
		fields = append(fields, sitesuggestions.FieldReason)
	}
	if m.status != nil {
		fields = append(fields, sitesuggestions.FieldStatus)
	}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *SiteSuggestionsMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *SiteSuggestionsMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case sitesuggestions.FieldCreatedAt:
		return m.OldCreatedAt(ctx)
	case sitesuggestions.FieldUpdatedAt:
	...
	return nil, fmt.Errorf("unknown SiteSuggestions field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *SiteSuggestionsMutation) SetField(name string, value ent.Value) error {
	switch name {
	case sitesuggestions.FieldCreatedAt:
		v, ok := value.(time.Time)
		if !ok {
	...
	case sitesuggestions.FieldReason:
		...
		return nil
	case sitesuggestions.FieldStatus:
		v, ok := value.(sitesuggestions.Status)
		if !ok {
			return fmt.Errorf("unexpected type %T for field %s", value, name)
		}
		m.SetStatus(v)
	...
	return fmt.Errorf("unknown SiteSuggestions field %s", name)
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *SiteSuggestionsMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown SiteSuggestions numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *SiteSuggestionsMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(sitesuggestions.FieldCategories) {
		fields = append(fields, sitesuggestions.FieldCategories)
	}
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *SiteSuggestionsMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *SiteSuggestionsMutation) ClearField(name string) error {
	switch name {
	case sitesuggestions.FieldCategories:
		m.ClearCategories()
		return nil
	...
	return fmt.Errorf("unknown SiteSuggestions nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *SiteSuggestionsMutation) ResetField(name string) error {
	switch name {
	case sitesuggestions.FieldCreatedAt:
		m.ResetCreatedAt()
		return nil
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *SiteSuggestionsMutation) RemovedIDs(name string) []ent.Value {
	return nil
}
