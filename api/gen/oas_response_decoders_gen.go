...
func decodeCreateCategoryResponse(resp *http.Response) (res CreateCategoryRes, _ error) {
	...
	case 409:
		// Code 409.
		return &CreateCategoryConflict{}, nil
	}
	return res, validate.UnexpectedStatusCodeWithResponse(resp)
}
...
func decodeDeleteCategoryResponse(resp *http.Response) (res DeleteCategoryRes, _ error) {
	...
	case 404:
		// Code 404.
		return &DeleteCategoryNotFound{}, nil
	}
	return res, validate.UnexpectedStatusCodeWithResponse(resp)
}
...
func decodeGetSiteSuggestionResponse(resp *http.Response) (res *SiteSuggestion, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
...
func decodeResolveSiteSuggestionResponse(resp *http.Response) (res *SiteSuggestion, _ error) {
	switch resp.StatusCode {
	case 201:
		// Code 201.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
