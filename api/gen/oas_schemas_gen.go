...
// CreateCategoryConflict is response for CreateCategory operation.
type CreateCategoryConflict struct{}

func (*CreateCategoryConflict) createCategoryRes() {}
...
// DeleteCategoryNotFound is response for DeleteCategory operation.
type DeleteCategoryNotFound struct{}

func (*DeleteCategoryNotFound) deleteCategoryRes() {}
...
// DeleteSiteNotFound is response for DeleteSite operation.
type DeleteSiteNotFound struct{}

func (*DeleteSiteNotFound) deleteSiteRes() {}
...
func (s *ISP) SetCity(val OptString) {
	s.City = val
}
...
// GetCity returns the value of City.
func (s *ISPDetails) GetCity() string {
	return s.City
}
...
// SetCity sets the value of City.
func (s *ISPDetails) SetCity(val string) {
	s.City = val
}
...
// GetCity returns the value of City.
func (s *ISPInput) GetCity() string {
	return s.City
}
...
// SetCity sets the value of City.
func (s *ISPInput) SetCity(val string) {
	s.City = val
}
