...
type ListISPsParams struct {
	...
	// Sort order.
	Order OptListISPsOrder `json:",omitempty,omitzero"`
}
...
type ListSiteSuggestionsParams struct {
	...
	Sort OptString `json:",omitempty,omitzero"`
	// Sort order.
	Order OptListSiteSuggestionsOrder `json:",omitempty,omitzero"`
}
...
type ListSitesParams struct {
	...
	Sort OptString `json:",omitempty,omitzero"`
	// Sort order.
	Order OptListSitesOrder `json:",omitempty,omitzero"`
}
...
// ResolveSiteSuggestionParams is parameters of resolveSiteSuggestion operation.
type ResolveSiteSuggestionParams struct {
	ID int
}

func unpackResolveSiteSuggestionParams(packed middleware.Parameters) (params ResolveSiteSuggestionParams) {
	{
		key := middleware.ParameterKey{
			Name: "id",
			In:   "path",
...
func decodeResolveSiteSuggestionParams(args [1]string, argsEscaped bool, r *http.Request) (params ResolveSiteSuggestionParams, _ error) {
	// Decode path: id.
	if err := func() error {
		param := args[0]
		if argsEscaped {
