					...
					case 's': // Prefix: "suggestions"
						...
						case '/': // Prefix: "/"
							...
							if len(elem) == 0 {
								switch r.Method {
								case "GET":
									s.handleGetSiteSuggestionRequest([1]string{
										args[0],
									}, elemIsEscaped, w, r)
								default:
									s.notAllowed(w, r, "GET")
							...
							case '/': // Prefix: "/resolve"
								...
								if len(elem) == 0 {
									...
									switch r.Method {
									case "POST":
										s.handleResolveSiteSuggestionRequest([1]string{
											args[0],
										}, elemIsEscaped, w, r)
									default:
					...
					case 's': // Prefix: "suggestions"
						...
						case '/': // Prefix: "/"
							...
							if len(elem) == 0 {
								switch method {
								case "GET":
									r.name = GetSiteSuggestionOperation
									r.summary = "Get a site suggestion by ID"
									r.operationID = "getSiteSuggestion"
									r.operationGroup = ""
									r.pathPattern = "/sites/suggestions/{id}"
									r.args = args
									r.count = 1
									return r, true
								default:
							...
							case '/': // Prefix: "/resolve"
								...
								if len(elem) == 0 {
									...
									switch method {
									case "POST":
										r.name = ResolveSiteSuggestionOperation
										r.summary = "Resolve a site suggestion"
										r.operationID = "resolveSiteSuggestion"
										r.operationGroup = ""
										r.pathPattern = "/sites/suggestions/{id}/resolve"
										r.args = args
										r.count = 1
										return r, true
									default:
